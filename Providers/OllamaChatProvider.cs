...
public class OllamaChatProvider : IDocumentChatProvider
{
    private readonly ChatClient _client;
    public string ProviderName => "Ollama (llama3.1:8b)";

    public OllamaChatProvider(string model = "llama3.1:8b", string baseUrl = "http://localhost:11434/v1")
    {
